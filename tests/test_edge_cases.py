...
def _execute_context(
    connection, symbol: str, depth: int = 1, limit: int = 100, impl: bool = False
) -> dict:
...
class TestEdgeCaseEmptyResults:
    ...
    def test_leaf_method_may_have_empty_uses(self, loaded_database):
        ...
        d = _execute_context(loaded_database, "App\\Entity\\Address::getFullAddress()", depth=1)
...
class TestEdgeCaseDeepDepth:
    ...
    def test_depth_5_on_short_chain_stops_early(self, loaded_database):
        ...
        d = _execute_context(loaded_database, "App\\Entity\\Address::getFullAddress()", depth=5)
        assert d["maxDepth"] == 5
    ...
    def test_depth_5_matches_depth_3_golden(self, loaded_database):
        ...
        d3 = _execute_context(loaded_database, "App\\Service\\OrderService::createOrder()", depth=3)
        d5 = _execute_context(loaded_database, "App\\Service\\OrderService::createOrder()", depth=5)
...
class TestEdgeCaseLimitEnforcement:
    ...
    def test_limit_1_constrains_used_by(self, loaded_database):
        ...
        d = _execute_context(loaded_database, "App\\Entity\\Order", depth=1, limit=1)
    ...
    def test_limit_100_returns_full_results(self, loaded_database):
        ...
        d = _execute_context(loaded_database, "App\\Entity\\Order", depth=1, limit=100)
...
class TestEdgeCaseConstructorRedirect:
    ...
    def test_constructor_shows_class_used_by(self, loaded_database):
        ...
        d = _execute_context(loaded_database, "App\\Entity\\Order::__construct()", depth=2)
        # Constructor redirect means usedBy should show class-level usages
        # (instantiations, type_hints, etc.)
        assert len(d["usedBy"]) > 0, "Constructor redirect should produce non-empty usedBy"
    ...
    def test_constructor_has_class_like_ref_types(self, loaded_database):
        ...
        d = _execute_context(loaded_database, "App\\Entity\\Order::__construct()", depth=1)
        ...
        assert ref_types & class_ref_types, f"Expected class-level refTypes, got: {ref_types}"
